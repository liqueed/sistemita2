# Generated by Django 2.2.2 on 2019-06-27 00:34
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('facturacion_clientes', '0020_pagoclientetransferenciaaliqueed'),
    ]

    operations = [
        migrations.CreateModel(
            name='FondoAdministrativo',
            fields=[
        ...
        migrations.AddField(
            ...
            name='estado',
            field=models.CharField(choices=[('PENDIENTE', 'Pendiente'), ('DISPONIBLE', 'Disponible'), ('COBRADO', 'Cobrado')], default='PENDIENTE', max_length=10),
        ),
        migrations.AddField(
        ...
        migrations.DeleteModel(
            name='FondoAdministrativoPendienteDeCobro',
        ),
    ]
