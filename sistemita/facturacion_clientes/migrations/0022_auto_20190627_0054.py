# Generated by Django 2.2.2 on 2019-06-27 00:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('facturacion_clientes', '0021_auto_20190627_0034'),
    ]

    operations = [
        migrations.RemoveField(
            model_name='deliveryindividualpendientedecobro',
            name='estado',
        ),
        migrations.RemoveField(
            model_name='deliveryindividualpendientedecobro',
        ...
        migrations.RemoveField(
            model_name='deliveryymentoringpendientesdecobro',
            name='estado',
        ),
        migrations.RemoveField(
            model_name='deliveryymentoringpendientesdecobro',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monto', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='ARS', max_digits=10)),
                ('fecha', models.DateField(auto_now=True)),
                ('estado', models.CharField(choices=[('PENDIENTE', 'Pendiente'), ('DISPONIBLE', 'Disponible'), ('COBRADO', 'Cobrado')], default='PENDIENTE', max_length=10)),
                ('factura', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='facturacion_clientes.FacturaCliente')),
            ],
        ),
        migrations.AddField(
            model_name='deliveryindividualpendientedecobro',
            name='movimientocuenta_ptr',
            field=models.OneToOneField(auto_created=True, default=None, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='facturacion_clientes.MovimientoCuenta'),
