...
class FacturaImputadaProveedorCreateViewAPITestCase(BaseTestCase):
    ...
    def test_validate_fields_required(self):
        ...
        self.create_user()
        self.client.login(username='user', password='user12345')
        response = self.client.post('/api/facturaproveedor-imputada/', {}, format='json')
        required_fields = [
            'fecha',
            'proveedor_id',
            'facturas_list',
...
class FacturaImputadaRetrieveViewAPITestCase(BaseTestCase):
    """Tests sobre el detalle de la API de facturas imputadas a proveedor."""
    ...
    def test_retrieve_with_user_authenticated(self):
        ...
        self.create_user()
        self.client.login(username='user', password='user12345')
        factura = FacturaImputadaProveedorFactory.create()
        response = self.client.get(f'/api/facturaproveedor-imputada/{factura.pk}/')
        self.assertEqual(response.status_code, 200)
    ...
    def test_list_with_user_anonymous(self):
        ...
        factura = FacturaImputadaProveedorFactory.create()
        request = self.client.get(f'/api/facturaproveedor-imputada/{factura.pk}/')
        self.assertEqual(request.status_code, 403)
    ...
    def test_retrieve_not_found(self):
        ...
        request = self.client.get(f'/api/facturaproveedor-imputada/{random}/')
