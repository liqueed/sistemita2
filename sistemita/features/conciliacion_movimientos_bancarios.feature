...
Escenario: Un solo movimiento aún no conciliado
Dado que "OSDE" es cliente
Y que en liqueed hay tarjetas de crédito corporativas "VISA"
Cuando se facture desde liqueed "500" pesos el "3/1/2010" al cliente "OSDE" con "0" pesos de gastos
Y se produjo el movimiento del "04/02/2010" con sucursal de origen código "762" y descripción "Cerrito", código operativo "2377", referencia "6968308", concepto "Pago Proveedores Interbanking Exte  - O.s.d.e. 30546741253 03 6968308", importe "500,00" y saldo "0,00"
Y se concilia la última factura con el último movimiento bancario
Y se produjo el movimiento del "04/02/2010" con sucursal de origen código "762" y descripción "Cerrito", código operativo "1325", referencia "29797706", concepto "Visa  - Por Deb:05/08/2019 Part 000000000729797706", importe "1000" y saldo "0"
Y se concilia el último movimiento bancario con el último pago de la tarjeta "VISA"
Y se produjo el movimiento del "04/02/2010" con sucursal de origen código "762" y descripción "Cerrito", código operativo "1325", referencia "29797707", concepto "Vis  - Por Deb:05/08/2019 Part 000000000729797706", importe "1000" y saldo "0"
Entonces la cantidad de movimientos bancarios aún no conciliados es de "1"