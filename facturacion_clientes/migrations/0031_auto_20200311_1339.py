...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('facturacion_clientes', '0030_remove_pagoimpuestoalcheque_pago'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='PagoLiqueedAConsultorSinConciliar',
            fields=[
                ...
                ('facturador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='facturacion_clientes.FacturadorDeConsultor')),
                ('movimiento_bancario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='facturacion_clientes.MovimientoBancario')),
            ],
        ),
        migrations.AddField(
            model_name='pagoliqueedaconsultor',
            name='pagoliqueedaconsultorsinconciliar_ptr',
            field=models.OneToOneField(auto_created=True, default=None, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='facturacion_clientes.PagoLiqueedAConsultorSinConciliar'),
